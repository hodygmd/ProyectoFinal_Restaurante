                    ...
                    <section class="content">
                        <div class="container-fluid">
                            ...
                            function llenar($campo)
                            {
                                ...
                                $consulta = "SELECT * FROM presentacion WHERE id_presentacion='" . $_GET['clave'] . "'";
                            ...
                            <form class="row g-3 needs-validation text-light" novalidate action="#" method="post">
                                ...
                                <div class="col-6">
                                    ...
                                    <input name="desc" type="text" class="textbox form-control" required value="<?php llenar($campo = 1);
                                                                                                                        ?>">
                                </div>
                                <div class="col-3"></div>
