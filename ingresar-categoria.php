                    ...
                    <div class="container-fluid">
                        <form class="row g-3 needs-validation text-light" novalidate action="#" method="post">
                            <div class="col-6">
                                ...
                                <input name="nombre" type="text" class="textbox form-control" required placeholder="Ingesar nombre de la Categoria">
                            </div>
                            <div class="col-6">
                                <label>Descripcion Categoria:</label>
                                <input name="desc" type="text" class="textbox form-control" required placeholder="Ingesar existencias de la Categoria">
                                <br>
                            </div>                            
