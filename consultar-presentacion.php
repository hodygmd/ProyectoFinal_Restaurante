...
<head>
    ...
    <title>Consultar Presentacion</title>
</head>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <?php
                                    if($_SESSION['rol']=="Administrador"){
                                        echo "<li><a class='dropdown-item' href='ingresar-presentacion.php'>Ingresar</a></li>";
                                    }
                                ?>
                        ...
                        <div class="container-fluid">
                            ...
                            <table class="table table-hover text-light">
                                <thead>
                                    <tr>
                                        <th scope="col">id</th>
                                        <th scope="col">Nombre Presentacion</th>
                                ...
                                <tbody>
                                    <?php
                                    include("connect/connection-mysql.php");
                                    $queryP = "SELECT * FROM presentacion WHERE status_presentacion=1";
                                    ...
                                    <td>" . $tabla[2] . "</td>";
                                    if($_SESSION['rol']=="Administrador"){
                                        echo "<td><a href='actualizar-presentacion.php?clave=$tabla[0]'><i class='fas fa-edit' title='Editar'></i></a></td>
                                        <td><a href='consultar-presentacion.php?clave=$tabla[0]'><i class='fas fa-trash-alt' title='Eliminar'></i></a></td>
                                        </tr>";
                                    }
                                    }
                                    ?>
