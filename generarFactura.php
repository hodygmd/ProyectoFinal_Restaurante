...
if (isset($_SESSION['usuario'])) {
    ...
    $queryP = "call MostrarFactura ('" . $_SESSION['usuario'] . "', '" . $_GET['folio']. "');";
    ...
    //
    $pdf->SetXY(30, 27);
    $pdf->Cell(10, 10, 'La Polar ', 0, 1);
    //
    $pdf->SetXY(30, 36);
    $pdf->SetFont("Arial", 'I', 9);
    $texto = utf8_decode("La mejor birria de mexico");
    $pdf->Cell(10, 5, $texto, 0, 1);
    //
    $pdf->SetXY(10, 50);
    $pdf->SetFont("Arial", '', 10);
    $texto = utf8_decode("Dirección: Jilotepec, Mexico");
    ...
    //
    $pdf->SetXY(10, 60);
    $texto = utf8_decode("Teléfono: 5516956740");
    $pdf->Cell(10, 0, $texto, 0);
    //
    $pdf->SetXY(10, 65);
